...
import co.edu.ucc.app.web.api.rest.ICuentaController;
...
public class CuentaControllerImpl implements ICuentaController {
    ...
    public ResponseEntity<GenericResponseDTO> crear(@Valid @RequestBody CuentaDTO cuentaDTO, HttpServletRequest request) throws Exception {
        try {

            GenericResponseDTO salida = cuentaService.crear(cuentaDTO);
    ...
    public ResponseEntity<GenericResponseDTO> consultarId(@PathVariable(value = "id", required = true) BigDecimal id, HttpServletRequest request) throws Exception {
        try {
            ...
            GenericResponseDTO salida = cuentaService.consultarPorId(id);
    ...
    public ResponseEntity<GenericResponseDTO> eliminarPorId(@PathVariable(value = "id", required = true) BigDecimal id,  HttpServletRequest request) throws Exception {
        try {
            ...
            GenericResponseDTO salida = cuentaService.eliminarPorId(id);
